...
public class ProcessRemoveRight {
    ...
    public ProcessRemoveRight(int userId, Model model, Errors errors, AddRoleRightForm form, RoleDAO roleDao, RightsDAO rightsDao) {
        this.userId = userId;
        this.model = model;
        this.errors = errors;
        this.form = form;
